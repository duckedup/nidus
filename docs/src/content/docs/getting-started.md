...
nidus is a library, not a server. You add it as a dependency, open a store in a
directory of your choosing, and call methods. There is nothing to install, no
daemon to run, and no network.
