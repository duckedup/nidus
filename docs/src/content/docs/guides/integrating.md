...
Threads pay off best paired with [int8 quantization](/guides/vector-search/#quantization):
...
[`rank_by`](/guides/vector-search/#ranking-by-recency) runs **single-threaded** regardless. It
